# Chatbot Secretaría Virtual - CIPFP Mislata
...
* **Diseño:** Implementado con **Tailwind CSS v4** para una interfaz moderna y profesional.
* **Backend:** El chat se comunica mediante una **API Gateway de AWS** con una función **Lambda**.
...
---
*Proyecto realizado para la asignatura de IABD - CIPFP Mislata*